...
const contact = () => {
	return (
		<div className='bg-white mb-20'>
			<div className='w-full p-20 bg-bottom bg-cover bg-[url("/images/contact-bg.jpg")]'>
				...
				<div className='inter flex-1 flex flex-col gap-[20px] justify-center items-center p-10 font-[500] text-[20px]'>			
					...
					<div tabindex="0" className="collapse collapse-arrow border border-base-300 bg-base-100 rounded-box">
  					...
  					<div className="collapse-content"> 
							...
							<br />
							<p className='font-[700]'>All about check-in</p>
							<p>
							...
							<br />
							<p className='font-[700]'>The scoop on check-out</p>
							<p>
					...
					<div tabindex="0" className="collapse collapse-arrow border border-base-300 bg-base-100 rounded-box">
  					...
  					<div className="collapse-content"> 
							...
							<Link href='/'>
								<span className='primary cursor-pointer	underline underline-offset-4 decoration-[primary]'>Find your Booking </span>
							</Link>
							<span>
